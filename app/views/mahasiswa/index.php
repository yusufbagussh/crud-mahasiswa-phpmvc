<div class="container">
    ...
    <div class="row">
        <div class="col-6">
            ...
            <button type="button" class="btn btn-primary mt-3 tombolTambahData" data-toggle="modal" data-target="#formModal">
            ...
            <?php foreach ($data['mhs'] as $mhs) : ?>
                <ul class="list-group">
                    <li class="list-group-item ">
                        <?= $mhs['nama']; ?>
                        <a href="<?= BASEURL; ?>/mahasiswa/hapus/<?= $mhs['id']; ?>" class="badge badge-danger float-right ml-1" onclick="return confirm('Yakin ingin menghapus data ini?');">hapus</a>
